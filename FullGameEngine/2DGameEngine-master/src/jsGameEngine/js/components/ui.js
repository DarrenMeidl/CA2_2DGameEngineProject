...
class UI extends Component {
  ...
  //ADDED SET COLOUR, SET FONT, SET TEXTALIGN FUNCTIONS
  // A method to set the colour of the UI component.
  setColour(newColour) {
    this.color = newColour;
  }
  // A method to set the font of the UI component.
  setFont(newFont) {
    this.font = newFont;
  }
  // A method to set the font of the UI component.
  ...
  // A method to set the position of the UI component.
  setPos(newX, newY) {
    this.x = newX;
    this.y = newY;
  }
